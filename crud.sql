...
-- Create operations 
INSERT INTO Products (Name, StockQuantity, Price, SupplierID) VALUES ('Desk', '5', 79.99, 2);
INSERT INTO Suppliers (Name, ContactInfo, Location) VALUES ('LMN Distributors', 'lmn@example.com', 'Chicago');
INSERT INTO Customers (Name, Email, Address) VALUES ('Alice Brown', 'alice@example.com', '789 Pine St');
...
UPDATE Customers SET Email = 'new_jane@example.com' WHERE Name = 'Jane Smith';
